...
var filter_gender = Number(args.filter_gender);//是否筛选段位
var gender_choose = Number(args.gender_choose)//筛选对象
...
function sendEmoji()
{
    ...
    var t = random(1,emoji.length-1)
    sleep(200)
    emoji[t].parent().parent().click()
    sleep(2000)
    //过滤表情依赖
